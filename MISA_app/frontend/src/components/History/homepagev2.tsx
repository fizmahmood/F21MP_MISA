...
//               Cultural, National and Religious laws to provide accurate wealth distribution based on your selection.
//             </p>
//           </Card.Body>
//         </Card>
//       </Container>
...
//                   variant="primary"
//                   disabled={loadingSystem !== null && loadingSystem !== "China Inheritance"}
//                 >
...
//                   variant="primary"
//                   disabled={loadingSystem !== null && loadingSystem !== "India Inheritance"}
//                 >
...
//                 <Card.Text>
//                   This system follows Russian inheritance laws for inheritance distribution.
//                 </Card.Text>
//                 <Button
//                   onClick={() => handleGenerateResults("Russia Inheritance")}
//                   variant="primary"
//                   disabled={loadingSystem !== null && loadingSystem !== "Russia Inheritance"}
//                 >
...
//          <h2 className="mb-3 text-center">🕌 Cultural & Religious Inheritance Systems</h2>
//         <Row className="mb-4">
...
//                   variant="primary"
//                   disabled={loadingSystem !== null && loadingSystem !== "Hindu Inheritance"}
//                 >
...
//                   variant="primary"
//                   disabled={loadingSystem !== null && loadingSystem !== "Islamic Inheritance"}
//                 >
...
//             <Card className="shadow-lg border-0">
//               <Card.Body>
//                 <Card.Title>Yoruba Inheritance</Card.Title>
//                 <Card.Text>
//                   This system calculates inheritance based on Yoruba traditions.
//                 </Card.Text>
//                 <Button
//                   onClick={() => handleGenerateResults("Yoruba Inheritance")}
//                   variant="primary"
//                   disabled={loadingSystem !== null && loadingSystem !== "Yoruba Inheritance"}
//                 >
